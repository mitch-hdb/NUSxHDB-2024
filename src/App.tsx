    ...
    <>
      <div className='login-page'>
        ...
        <div className='login-input-container flex flex-col gap-2 !mt-6'>
          <MyButton variant='outlined' fullwidth startIcon={<GoogleIcon />}>
            Continue With Google
          </MyButton>
          <MyButton variant='outlined' fullwidth startIcon={<FacebookIcon />}>
            Continue With Facenook
          </MyButton>
          <MyButton variant='outlined' fullwidth startIcon={<AppleIcon />}>
            Continue With Apple
          </MyButton>
        </div>
